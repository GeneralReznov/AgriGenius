...
# Set page config
st.set_page_config(page_title="Agriculture and Solar Power Prediction System", layout="wide")

# Sidebar for navigation
st.sidebar.title("Navigation")
page = st.sidebar.radio("Go to", ["About the Project", "Crop Recommendation", "Fertilizer Recommendation", "Solar Power Prediction"])

# About the Project page
if page == "About the Project":
    st.title("About the Agriculture and Solar Power Prediction System")
    st.write("""
    This project aims to help farmers make informed decisions about crop selection, fertilizer usage,
    and predict solar power generation based on various environmental factors.
    
    Our system uses machine learning models to provide recommendations and predictions based on input data.
